                ...
                <div className="fixed-header">
                    <div className="content-wrapper header-content">
                        ...
                        {/* <div className="side-menu-button"><a href="#"><i className="fas fa-bars"></i></a></div> */}
                            <div className="title"><Link to="/">Litty</Link></div>
                        </div>
                        <div className="navmenu">
                                <div className="diva">
                                <Link to="/">      <img src="/images/home-icon.svg" alt="home" /> </Link>
                                </div>
                                <div className="diva">  <Link to="/search">
                                    <img src="/images/search_white.svg" alt="discover" /></Link>
                                </div>
                                <div className="diva">
                   ...
                   {userDetail &&      <div className="header-right-side">
                            ...
                            <Link to="/my-profile"> <div className="user-avatar">
