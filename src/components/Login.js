...
const Login = (props) =>{
    ...
    return(
      ...
      {loginError && (
          <div >
            <div className="errordiv" dangerouslySetInnerHTML={{ __html: loginError }} />
            <img src="/images/close_white.svg" alt = "X" onClick={() => setLoginError(null)} />
          </div>
      )}
       </div>
        <div className="main-container__content">
          ...
          <button type="button" className="button">Or</button>
